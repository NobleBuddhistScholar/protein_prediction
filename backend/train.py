...
if __name__ == "__main__":
    ...
    import os
    print(os.path.exists('model/tttt.pth'), os.path.exists('model/tttt.json'))
    # 测试模型训练
    config = {
        'max_length': 10000,
        'batch_size': 32,
    ...
    # classifier = ProteinClassifier.per_train_load(model_path='model/tttt.pth',config=config,model_info_path='model/tttt.json', model='HybridModel')
    # classifier.train(
